...
export default function LGService() {
  useEffect(() => {
    ...
    document.title = "صيانة ال جي الإسكندرية | مركز خدمة LG المتخصص 01558625259";
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-rose-900">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="صيانة ال جي المتخصصة بالإسكندرية"
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-rose-500/20 border border-rose-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              ...
              <span className="text-rose-400 font-bold text-sm uppercase tracking-wider">مركز خدمة LG المتخصص - الإسكندرية</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز خدمة <span className="text-rose-600">ال جي</span> <br />في الإسكندرية
              </h2>
              ...
              <div className="bg-rose-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-rose-900/20">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a href="tel:+201558625259" className="inline-flex items-center gap-2 bg-rose-800 text-white px-8 py-4 rounded-2xl font-black transition-transform hover:scale-105 border border-rose-400/30">
                    <Phone className="w-6 h-6" />
                    اتصال فوري
                  </a>
                </div>
            ...
            <div className="relative">
              ...
              <img src="/images/services/washing-machine-repair-pro.webp" alt="فني صيانة ال جي الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" loading="lazy" decoding="async" />
