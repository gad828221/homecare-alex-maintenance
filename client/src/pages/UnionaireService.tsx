...
export default function UnionaireService() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-96 overflow-hidden bg-gradient-to-r from-cyan-600 to-cyan-800">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">صيانة يونيون إير في الإسكندرية</h1>
            <p className="text-xl md:text-2xl mb-8">خدمة متخصصة لأجهزة يونيون إير - تكييفات، غسالات، ثلاجات</p>
            <Button
              size="lg"
