...
export default function UnionaireService() {
  useEffect(() => {
    // Dynamic SEO Update
    document.title = "صيانة يونيون اير الإسكندرية | رقم صيانة Unionaire المعتمد 01278885772";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "هل تبحث عن صيانة يونيون اير بالإسكندرية؟ نحن مركز معتمد لصيانة كافة أجهزة Unionaire (ثلاجات، غسالات، تكييفات) بالمنزل بقطع غيار أصلية وضمان سنة.");
    
    // Schema Markup for Google Ads Quality Score
    const schema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "صيانة يونيون اير الإسكندرية",
      ...
      "description": "خدمة صيانة يونيون اير المعتمدة في الإسكندرية بقطع غيار أصلية."
    };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-blue-900">
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/hero-bg-new.jpg" 
            alt="صيانة يونيون اير المعتمدة بالإسكندرية" 
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              ...
              <span className="text-blue-400 font-bold text-sm uppercase tracking-wider">مركز صيانة Unionaire المعتمد - الإسكندرية</span>
            </div>
            
            <h1 className="text-4xl md:text-7xl font-black text-white leading-tight mb-6">
              رقم صيانة <span className="text-blue-400">يونيون اير</span> <br />
            ...
            <p className="text-xl text-slate-200 mb-10 font-medium leading-relaxed max-w-2xl">
              نحن الخيار الأول لصيانة أجهزة Unionaire في الإسكندرية. نغطي كافة المناطق (سموحة، لوران، العجمي، السيوف) ونصلك خلال 60 دقيقة.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white text-xl font-black px-10 py-8 rounded-2xl shadow-2xl shadow-blue-900/40 transition-all transform hover:scale-105"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-blue-600 transition-all duration-300">
              <Clock className="w-10 h-10 text-blue-600 mx-auto mb-4 group-hover:text-white" />
            ...
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-blue-600 transition-all duration-300">
              <MapPin className="w-10 h-10 text-blue-600 mx-auto mb-4 group-hover:text-white" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز صيانة <span className="text-blue-600">يونيون اير</span> <br />في الإسكندرية
              </h2>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed font-medium">
                هل تعاني من أعطال في أجهزة Unionaire؟ لا داعي للقلق. نحن نوفر لك خدمة صيانة منزلية فورية باستخدام أحدث معدات الفحص الإلكتروني لتحديد العطل بدقة متناهية وتوفير التكلفة.
              </p>
              ...
              <div className="bg-blue-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-blue-900/20">
            ...
            <div className="relative">
              ...
              <img src="/images/services/washing-machine-repair-pro.jpg" alt="فني صيانة يونيون اير الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" />
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['سموحة', 'سيدي جابر', 'لوران', 'العجمي', 'السيوف', 'المنتزه', 'جليم', 'الإبراهيمية', 'محرم بك', 'سيدي بشر'].map(area => (
              <span key={area} className="px-6 py-3 bg-white/5 border border-white/10 rounded-full font-bold hover:bg-blue-600 transition-colors">
                صيانة يونيون اير {area}
              </span>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white p-2 rounded-[3rem] shadow-2xl border border-slate-200">
            <BookingForm defaultService="صيانة يونيون اير" />
          </div>
        </div>
      </section>
