    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-8">عن خدمات صيانة شارب</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-700 mb-4">
                شارب من الماركات الموثوقة والمشهورة عالمياً. نحن متخصصون في صيانة جميع أجهزة Sharp بخدمة احترافية وسريعة.
              </p>
              <p className="text-gray-700 mb-4">
                فريقنا مدرب على أحدث تقنيات إصلاح أجهزة شارب ويستخدم قطع غيار أصلية معتمدة.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span>فنيون معتمدون من Sharp</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              <h3 className="text-2xl font-bold mb-4 text-purple-600">أجهزة Sharp التي نصلحها:</h3>
              <ul className="space-y-3">
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-purple-600" />
                  <span>ثلاجات Sharp بجميع الموديلات</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-purple-600" />
                  <span>غسالات Sharp الأوتوماتيكية</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-purple-600" />
                  <span>تكييفات Sharp بجميع الأنواع</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-purple-600" />
                  <span>أجهزة Sharp الأخرى</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12">المشاكل الشائعة في أجهزة Sharp</h2>
      ...
      {/* Booking Form */}
      <section id="contact">
        <BookingForm title="احجز خدمة صيانة Sharp الآن" defaultService="fridge" />
      </section>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                name: "مريم حسن",
                text: "خدمة ممتازة! الفني أصلح الثلاجة بسرعة واحترافية عالية جداً.",
                rating: 5,
              },
              {
                name: "خالد محمود",
                text: "أسعار منافسة جداً وخدمة سريعة. سأتعامل معهم مرة أخرى.",
                rating: 5,
              },
              {
                name: "دينا أحمد",
                text: "فنيون محترفون جداً. استخدموا قطع غيار أصلية وأعطوا ضمان.",
                rating: 5,
              },
