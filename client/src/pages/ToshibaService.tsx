...
export default function ToshibaService() {
  useEffect(() => {
    ...
    document.title = "صيانة توشيبا الإسكندرية | مركز خدمة Toshiba المتخصص 01558625259";
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-red-900">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="صيانة توشيبا المتخصصة بالإسكندرية"
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-red-500/20 border border-red-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              ...
              <span className="text-red-400 font-bold text-sm uppercase tracking-wider">مركز خدمة Toshiba المتخصص - الإسكندرية</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز خدمة <span className="text-red-600">توشيبا</span> <br />في الإسكندرية
              </h2>
            ...
            <div className="relative">
              ...
              <img src="/images/services/washing-machine-repair-pro.webp" alt="فني صيانة توشيبا الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" loading="lazy" decoding="async" />
