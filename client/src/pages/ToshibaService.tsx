...
<section className="relative h-96 overflow-hidden">
  <div className="absolute inset-0 bg-gradient-to-r from-amber-600 to-amber-800 mix-blend-multiply" />
  <img 
    src="/images/brands/toshiba-hero.jpg" 
    alt="صيانة توشيبا" 
    className="absolute inset-0 w-full h-full object-cover"
  />
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white px-4">
      <h1 className="text-4xl md:text-5xl font-bold mb-4">صيانة توشيبا في الإسكندرية</h1>
      <p className="text-xl md:text-2xl mb-8">خدمة متخصصة لجميع أجهزة توشيبا - ثلاجات، غسالات، تكييفات</p>
      <Button
        size="lg"
      ...
      {/* About Toshiba Service */}
      <section className="py-12 bg-gray-50">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-8">عن خدمات صيانة توشيبا</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-700 mb-4">
                توشيبا من الشركات الرائدة في صناعة الأجهزة المنزلية. نحن متخصصون في صيانة جميع أجهزة توشيبا بخدمة احترافية وسريعة.
              </p>
              <p className="text-gray-700 mb-4">
                فريقنا مدرب على أحدث تقنيات إصلاح أجهزة توشيبا ويستخدم قطع غيار أصلية معتمدة.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span>فنيون معتمدون من توشيبا</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-500" />
            ...
            <div className="bg-red-50 p-6 rounded-lg">
              <h3 className="text-2xl font-bold mb-4 text-red-600">أجهزة توشيبا التي نصلحها:</h3>
              <ul className="space-y-3">
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <span>ثلاجات توشيبا بجميع الموديلات</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <span>غسالات توشيبا الأوتوماتيكية</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <span>تكييفات توشيبا بجميع الأنواع</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <span>بوتاجازات توشيبا الغاز والكهرباء</span>
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <span>مكانس توشيبا الكهربائية</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12">المشاكل الشائعة في أجهزة توشيبا</h2>
      ...
      {/* Booking Form */}
      <section id="contact">
        <BookingForm title="احجز خدمة صيانة توشيبا الآن" />
      </section>
