...
export default function ToshibaService() {
  useEffect(() => {
    // Dynamic SEO Update
    document.title = "صيانة توشيبا الإسكندرية | رقم صيانة Toshiba المعتمد 01278885772";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "هل تبحث عن صيانة توشيبا بالإسكندرية؟ نحن مركز معتمد لصيانة كافة أجهزة Toshiba (ثلاجات، غسالات، تكييفات) بالمنزل بقطع غيار أصلية وضمان سنة.");
    
    // Schema Markup for Google Ads Quality Score
    const schema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "صيانة توشيبا الإسكندرية",
      ...
      "description": "خدمة صيانة توشيبا المعتمدة في الإسكندرية بقطع غيار أصلية."
    };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-red-900">
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/hero-bg-new.jpg" 
            alt="صيانة توشيبا المعتمدة بالإسكندرية" 
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-red-500/20 border border-red-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              <ShieldCheck className="w-4 h-4 text-red-400" />
              <span className="text-red-400 font-bold text-sm uppercase tracking-wider">مركز صيانة Toshiba المعتمد - الإسكندرية</span>
            </div>
            
            <h1 className="text-4xl md:text-7xl font-black text-white leading-tight mb-6">
              رقم صيانة <span className="text-red-400">توشيبا</span> <br />
            ...
            <p className="text-xl text-slate-200 mb-10 font-medium leading-relaxed max-w-2xl">
              نحن الخيار الأول لصيانة أجهزة Toshiba في الإسكندرية. نغطي كافة المناطق (سموحة، لوران، العجمي، السيوف) ونصلك خلال 60 دقيقة.
            </p>
      ...
      <div className="bg-white py-16 border-b border-slate-100">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-red-600 transition-all duration-300">
              <Clock className="w-10 h-10 text-red-600 mx-auto mb-4 group-hover:text-white" />
            ...
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-red-600 transition-all duration-300">
              <ShieldCheck className="w-10 h-10 text-red-600 mx-auto mb-4 group-hover:text-white" />
            ...
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-red-600 transition-all duration-300">
              <Award className="w-10 h-10 text-red-600 mx-auto mb-4 group-hover:text-white" />
            ...
            <div className="p-6 bg-slate-50 rounded-3xl text-center group hover:bg-red-600 transition-all duration-300">
              <MapPin className="w-10 h-10 text-red-600 mx-auto mb-4 group-hover:text-white" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز صيانة <span className="text-red-600">توشيبا</span> <br />في الإسكندرية
              </h2>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed font-medium">
                هل تعاني من أعطال في أجهزة Toshiba؟ لا داعي للقلق. نحن نوفر لك خدمة صيانة منزلية فورية باستخدام أحدث معدات الفحص الإلكتروني لتحديد العطل بدقة متناهية وتوفير التكلفة.
              </p>
              ...
              <div className="bg-red-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-red-900/20">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="https://wa.me/201558625259" className="inline-flex items-center gap-2 bg-white text-red-600 px-8 py-4 rounded-2xl font-black transition-transform hover:scale-105">
                    <MessageCircle className="w-5 h-5" />
                    واتساب
                  </a>
                  <a href="tel:+201278885772" className="inline-flex items-center gap-2 bg-red-800 text-white px-8 py-4 rounded-2xl font-black transition-transform hover:scale-105 border border-red-400/30">
                    <Phone className="w-6 h-6" />
                    اتصال فوري
                  </a>
                </div>
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-red-600/10 rounded-[3rem] blur-3xl"></div>
              <img src="/images/services/washing-machine-repair-pro.jpg" alt="فني صيانة توشيبا الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" />
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['سموحة', 'سيدي جابر', 'لوران', 'العجمي', 'السيوف', 'المنتزه', 'جليم', 'الإبراهيمية', 'محرم بك', 'سيدي بشر'].map(area => (
              <span key={area} className="px-6 py-3 bg-white/5 border border-white/10 rounded-full font-bold hover:bg-red-600 transition-colors">
                صيانة توشيبا {area}
              </span>
            ))}
          </div>
      ...
      <section id="contact" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-2 bg-red-600 mx-auto rounded-full mt-6"></div>
          </div>
          <div className="bg-white p-2 rounded-[3rem] shadow-2xl border border-slate-200">
            <BookingForm defaultService="صيانة توشيبا" />
          </div>
        </div>
      </section>
