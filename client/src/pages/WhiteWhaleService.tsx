          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-700 mb-4">
                وايت ويل من الماركات المتميزة في مجال الأجهزة المنزلية. نحن متخصصون في صيانة جميع أجهزة وايت ويل بخدمة احترافية.
              </p>
              <p className="text-gray-700 mb-4">
                فريقنا مدرب على أحدث تقنيات إصلاح أجهزة وايت ويل ويستخدم قطع غيار أصلية.
              </p>
