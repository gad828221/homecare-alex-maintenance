...
export default function BekoService() {
  useEffect(() => {
    ...
    document.title = "صيانة بيكو الإسكندرية | مركز خدمة Beko المتخصص 01558625259";
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-7xl font-black text-white leading-tight mb-6">
              رقم صيانة <span className="text-blue-400">بيكو</span> <br />
            ...
            <p className="text-xl text-slate-200 mb-10 font-medium leading-relaxed max-w-2xl">
              نحن الخيار الأول لصيانة أجهزة Beko في الإسكندرية. نغطي كافة المناطق (سموحة، لوران، العجمي، السيوف) ونصلك خلال 60 دقيقة.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              <img src="/images/services/washing-machine-repair-pro.webp" alt="فني صيانة بيكو الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" loading="lazy" decoding="async" />
      ...
      <section id="contact" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white p-2 rounded-[3rem] shadow-2xl border border-slate-200">
            <BookingForm defaultService="صيانة بيكو" />
          </div>
        </div>
      </section>
