            ...
            <div>
              ...
              <div className="bg-red-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-red-900/20">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a href="tel:01278885772" className="inline-flex items-center gap-2 bg-red-800 text-white px-8 py-4 rounded-2xl font-black transition-transform hover:scale-105 border border-red-400/30">
                    <Phone className="w-6 h-6" />
                    اتصال فوري
                  </a>
                </div>
