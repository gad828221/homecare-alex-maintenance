...
<section className="relative h-96 overflow-hidden">
  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-800 mix-blend-multiply" />
  <img 
    src="/images/brands/hoover-hero.jpg" 
    alt="صيانة هوفر" 
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white px-4">
      ...
      <p className="text-xl md:text-2xl mb-8">خدمة متخصصة لجميع أجهزة هوفر - غسالات، مكانس، أجهزة منزلية</p>
      <Button
        size="lg"
