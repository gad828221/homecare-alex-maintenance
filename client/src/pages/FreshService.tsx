...
export default function FreshService() {
  useEffect(() => {
    ...
    document.title = "صيانة فريش الإسكندرية | مركز خدمة Fresh المتخصص 01558625259";
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-blue-900">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="صيانة فريش المتخصصة بالإسكندرية"
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              ...
              <span className="text-blue-400 font-bold text-sm uppercase tracking-wider">مركز خدمة Fresh المتخصص - الإسكندرية</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز خدمة <span className="text-blue-600">فريش</span> <br />في الإسكندرية
              </h2>
            ...
            <div className="relative">
              ...
              <img src="/images/services/washing-machine-repair-pro.webp" alt="فني صيانة فريش الإسكندرية" className="relative rounded-[3rem] shadow-2xl w-full h-[600px] object-cover" loading="lazy" decoding="async" />
