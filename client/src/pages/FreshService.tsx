      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-blue-900">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="صيانة Fresh المعتمدة بالإسكندرية" 
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-blue-400 font-bold text-sm uppercase tracking-wider">مركز صيانة Fresh المعتمد</span>
            </div>
            ...
            <p className="text-xl text-slate-200 mb-10 font-medium leading-relaxed">
              نقدم خدمة صيانة احترافية لجميع أجهزة Fresh (ثلاجات، غسالات، تكييفات) في الإسكندرية. نصلك خلال ساعة واحدة فقط.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 mb-8 leading-tight">خدمة صيانة Fresh <br />بأعلى معايير الجودة</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed font-medium">
                نحن في مركز صيانة Fresh الإسكندرية، ندرك مدى أهمية أجهزتك المنزلية في حياتك اليومية. لذا، نقدم فريقاً من المهندسين المتخصصين والمدربين على أحدث تقنيات صيانة Fresh العالمية.
              </p>
              
              <div className="space-y-4 mb-10">
                {['صيانة ثلاجات Fresh بجميع الموديلات', 'تصليح غسالات Fresh أوتوماتيك وفوق أوتوماتيك', 'صيانة تكييفات Fresh سبليت وشباك', 'استخدام أجهزة فحص إلكترونية حديثة'].map((item, i) => (
              ...
              <div className="bg-blue-600 p-8 rounded-3xl text-white">
                ...
                <p className="font-bold opacity-90 mb-6">تواصل مع الدعم الفني لـ Fresh مباشرة عبر الواتساب</p>
            ...
            <div className="relative">
              <img src="/images/services/washing-machine-repair-pro.jpg" alt="فني صيانة Fresh" className="rounded-[2.5rem] shadow-2xl w-full h-[500px] object-cover" />
      ...
      <section id="contact" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white p-2 rounded-[2.5rem] shadow-2xl">
            <BookingForm defaultService="صيانة Fresh" />
          </div>
        </div>
      </section>
