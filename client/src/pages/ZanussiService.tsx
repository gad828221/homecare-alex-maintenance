...
export default function ZanussiService() {
  useEffect(() => {
    // Dynamic SEO Update
    document.title = "صيانة زانوسي الإسكندرية | رقم صيانة Zanussi المعتمد 01278885772";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "هل تبحث عن صيانة زانوسي بالإسكندرية؟ نحن مركز معتمد لصيانة كافة أجهزة Zanussi (ثلاجات، غسالات، تكييفات) بالمنزل بقطع غيار أصلية وضمان سنة.");
    ...
    const schema = {
      ...
      "description": "خدمة صيانة زانوسي المعتمدة في الإسكندرية بقطع غيار أصلية."
    };
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-yellow-900">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="صيانة زانوسي المعتمدة بالإسكندرية" 
        ...
        <div className="container mx-auto px-4 relative z-10 py-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-yellow-500/20 border border-yellow-500/30 px-4 py-2 rounded-full mb-6 animate-pulse">
              ...
              <span className="text-yellow-400 font-bold text-sm uppercase tracking-wider">مركز صيانة Zanussi المعتمد - الإسكندرية</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 leading-tight">
                أفضل مركز صيانة <span className="text-yellow-600">زانوسي</span> <br />في الإسكندرية
              </h2>
