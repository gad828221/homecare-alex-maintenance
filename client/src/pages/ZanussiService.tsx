            ...
            <div>
              ...
              <div className="bg-yellow-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-yellow-900/20">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="https://wa.me/201278885772" className="inline-flex items-center gap-2 bg-white text-yellow-600 px-8 py-4 rounded-2xl font-black transition-transform hover:scale-105">
