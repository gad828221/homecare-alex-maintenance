    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 pb-20 font-sans" dir="rtl">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-6">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-8">
          ...
          <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 shadow-sm">
            <p className="text-2xl font-black text-orange-500">{stats.totalIncome.toLocaleString()}</p>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] w-full max-w-2xl shadow-2xl my-auto overflow-hidden">
            ...
            <form onSubmit={saveOrder} className="p-8 space-y-6 max-h-[80vh] overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                  ...
                  {!isOtherDevice ? (
                    ...
                    <div className="flex gap-2">
                      <input type="text" required placeholder="الجهاز الجديد" value={customDevice} onChange={(e) => setCustomDevice(e.target.value)} className="flex-1 bg-slate-800 border border-slate-700 rounded-2xl px-5 py-3 text-sm outline-none focus:border-orange-500 transition-all" />
              ...
              <div className="grid grid-cols-2 gap-4 p-5 bg-slate-950 rounded-3xl border border-slate-800 shadow-inner">
                <div className="text-center"><p className="text-[10px] text-slate-500 font-bold uppercase mb-1">نصيب الشركة (40%)</p><p className="text-xl font-black text-blue-500">{formData.company_share} ج.م</p></div>
                <div className="text-center border-r border-slate-800"><p className="text-[10px] text-slate-500 font-bold uppercase mb-1">نصيب الفني (60%)</p><p className="text-xl font-black text-purple-500">{formData.technician_share} ج.م</p></div>
              </div>
