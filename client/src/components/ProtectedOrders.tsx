...
// ✅ دالة إرسال الإشعارات (بسيطة، تستخدم sendSelfNotification)
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200" dir="rtl">
      ...
      <div className="flex gap-2 p-4 border-b bg-slate-900 overflow-x-auto">
        ...
        <button onClick={() => sendPushNotification('🧪 اختبار يدوي', 'هذا إشعار تجريبي من التطبيق')} className="bg-red-600 text-white px-3 py-2 rounded-lg text-sm">🔥 اختبار نهائي</button>
