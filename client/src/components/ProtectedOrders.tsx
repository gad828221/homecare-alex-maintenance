...
export default function ProtectedOrders() {
  // ✅ إضافة الإشعارات المنبثقة للمدير
...
✨ نظام إدارة الصيانة - تقرير يومي`;
  ...
  const saveOrder = async (e: React.FormEvent) => {
    ...
    try {
      if (editingOrder) {
        ...
        // إشعار للفني إذا تم تغيير الفني أو تحديث البيانات
  ...
  const printAndSendInvoice = async (order: any) => {
    ...
    // تحديث الأوردر بالفاتورة المعتمدة
    ...
    // إرسال الفاتورة عبر الواتس بصيغة محسّنة
